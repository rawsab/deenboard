...
const Newtab = () => {
  ...
  return (
    <>
      <VantaBackground />
      <div className="relative min-h-screen p-6 flex flex-col justify-end gap-6 overflow-hidden">
          ...
          >
            ...
            <div className="flex flex-col items-start">
              ...
              <div
                ...
                style={{ fontFamily: 'Wix Madefor Display', lineHeight: 1.1 }}
              >
                Welcome, Rawsab
              </div>
            </div>
            ...
            >
              <div className="relative w-full">
                <span className="absolute left-4 top-1/2 -translate-y-1/2 text-[#ADADAD] -tracking-[0.025em] text-md">
                  <img src={magnifyingIcon} alt="Search" className="w-5 h-5" />
                </span>
                <input
                  ref={searchInputRef}
                  type="text"
          ...
          >
            ...
            <div
              className={`col-span-1 row-span-1 col-start-2 row-start-3 ${fadeClass(
                4
              )} border border-gray-300 bg-gray-100 rounded-[25px]`}
              style={fadeStyle(4)}
            />
            <div
